...
<div id="<?php echo $type; ?>-existing">
  <select name="address_id" style="width: 100%; margin-bottom: 15px;" size="5">
    ...
    <option value="<?php echo $address['address_id']; ?>" selected="selected"><?php echo $address['firstname']; ?> <?php echo $address['lastname']; ?>,  <?php echo $address['country']; ?>, <?php echo $address['city']; ?>,<?php echo $address['address_1']; ?></option>
    <?php } else { ?>
    <option value="<?php echo $address['address_id']; ?>"><?php echo $address['firstname']; ?> <?php echo $address['lastname']; ?>,  <?php echo $address['country']; ?>, <?php echo $address['city']; ?>,<?php echo $address['address_1']; ?></option>
    <?php } ?>
    <?php } ?>
  </select>
</div>
