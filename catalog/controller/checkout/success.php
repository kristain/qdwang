...
class ControllerCheckoutSuccess extends Controller { 
	public function index() { 	
        ...
        //通过确认订单注册用户用户名密码提示信息
		if(isset($this->session->data['temp_email'])){
			$this->data['new_customer'] = sprintf($this->language->get('new_customer'), $this->session->data['temp_email'], $this->session->data['temp_password']);
		}
		unset($this->session->data['temp_email']);
		unset($this->session->data['temp_password']);
