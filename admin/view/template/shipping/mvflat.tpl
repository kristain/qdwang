      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          <tr>
            ...
            <td><select name="mvflat_shipping_method">
		  ...
		  <tr>
            ...
            <td><select name="mvflat_tax_class_id">
          ...
          <tr>
            ...
            <td><select name="mvflat_geo_zone_id">
          ...
          <tr>
            ...
            <td><input type="text" name="mvflat_sort_order" value="<?php echo $mvflat_sort_order; ?>" size="1" /></td>
          </tr>
        </table>
      </form>
    </div>
