        ...
        <div id="tab-payment" class="vtabs-content">
          <table class="form">
            ...
            <tr>
             ...
             <!--为配合管理后台处理货到付款确认完成时发送邮件，此处需必输入以下三行	-->		
			<input type="hidden" name="lastname" value="" />
				  <input type="hidden" name="payment_lastname" value="" />
          ...
          <table class="list">
            <thead>
              <tr>
				...
				<td class="left"><?php echo $column_isbn; ?></td>
                <td class="left"><?php echo $column_model; ?></td>
                <td class="right"><?php echo $column_quantity; ?></td>
				<td class="right"><?php echo $column_sku; ?></td>
            ...
            <tbody id="product">
              ...
              <tr id="product-row<?php echo $product_row; ?>">
                ...
                <td class="left"><?php echo $order_product['name']; ?><br />
                  ...
                  <?php $download_row++; ?>
                  <?php } ?></td>
				<td class="left"><?php echo $order_product['isbn']; ?></td>
                ...
                <td class="right"><?php echo $order_product['quantity']; ?>
				  ...
				  <td class="right"><?php echo $order_product['sku']; ?></td>
		...
		success: function(json) {
			...
			if (json['order_product'] != '') {
				...
				for (i = 0; i < json['order_product'].length; i++) {
					...
					html += '  </td>';
					html += '  <td class="left">' + product['isbn'] + '<input type="hidden" name="order_product[' + product_row + '][isbn]" value="' + product['isbn'] + '" /></td>';
					...
					html += '  <td class="right">' + product['sku'] + '<input type="hidden" name="order_product[' + product_row + '][sku]" value="' + product['sku'] + '" /></td>';
			...
			if (json['order_product'] != '' || json['order_voucher'] != '' || json['order_total'] != '') {
				...
				if (json['order_product'] != '') {
					for (i = 0; i < json['order_product'].length; i++) {
						...
						html += '  </td>';
						html += '  <td class="left">' + product['isbn'] + '</td>';
