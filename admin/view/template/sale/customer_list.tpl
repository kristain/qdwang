        ...
        <table class="list">
          ...
          <tbody>
            <tr class="filter">
			  ...
			  <td><input type="text" name="filter_shop_name" value="<?php echo $filter_shop_name; ?>" /></td>
            ...
            <tr>
			  ...
			  <td class="left"><?php echo $customer['shop_name']; ?></td>
...
function filter() {
	...
	var filter_shop_name = $('input[name=\'filter_shop_name\']').attr('value');
	
	if (filter_shop_name) {
		url += '&filter_shop_name=' + encodeURIComponent(filter_shop_name);
	}
