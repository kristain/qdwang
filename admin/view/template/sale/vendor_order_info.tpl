...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <div class="vtabs"> <?php if ($this->config->get('sales_order_detail')) { ?><a href="#tab-order"><?php echo $tab_order; ?></a><?php } ?><?php if ($this->config->get('sales_payment_detail')) { ?><a href="#tab-payment"><?php echo $tab_payment; ?></a><?php } ?>
        <?php if ($shipping_method) { ?>
        <?php if ($this->config->get('sales_shipping_detail')) { ?><a href="#tab-shipping"><?php echo $tab_shipping; ?></a><?php } ?>
        <?php } ?>
        <?php if ($this->config->get('sales_product')) { ?><a href="#tab-product"><?php echo $tab_product; ?></a><?php } ?><?php if ($this->config->get('sales_order_history')) { ?><a href="#tab-history"><?php echo $tab_order_history; ?></a><?php } ?></div>
      ...
      <div id="tab-product" class="vtabs-content">
        <table id="product" class="list">
          ...
          <tbody id="totals">
			...
			<?php if ($tax) { ?>
			<tr>
              <td colspan="4" class="right"><?php echo $tax_title; ?> :</td>
