...
<div style="page-break-after: always;">
  ...
  <table class="store">
    <tr>
      ...
      <td align="right" valign="top"><table>
          ...
          <?php if ($order['shipping_weight']) { ?>
          <tr>
            <td><b><?php echo $text_shipping_method; ?></b></td>
            <td><?php echo $order['shipping_weight']; ?></td>
          </tr>
          <?php } ?>
        </table></td>
    </tr>
  ...
  <table class="product">
    ...
    <?php } ?>
    <tr>
      <td align="right" colspan="4"><b><?php echo $text_subtotal; ?>:</b></td>
      <td align="right"><?php echo $order['subtotal']; ?></td>
    </tr>
	<?php if ($order['shipping_weight']) { ?>
	<tr>
      <td align="right" colspan="4"><b><?php echo $order['shipping_weight']; ?>:</b></td>
      <td align="right"><?php echo $order['shipping_cost']; ?></td>
    </tr>
	<?php } ?>
	<?php if ($order['tax']) { ?>
	<tr>
      <td align="right" colspan="4"><b><?php echo $order['tax_title']; ?>:</b></td>
      <td align="right"><?php echo $order['tax']; ?></td>
    </tr>
	<?php } ?>
	<tr>
      <td align="right" colspan="4"><b><?php echo $column_total; ?>:</b></td>
