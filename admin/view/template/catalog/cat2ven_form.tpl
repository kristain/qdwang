...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-data"><?php echo $tab_data; ?></a><?php if ($this->config->get('vendor_desgin_tab')) { ?><a href="#tab-design"><?php echo $tab_design; ?></a><?php } ?></div>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-data">
          <table class="form">
			...
			<?php if ($this->config->get('vendor_menu_bar')) { ?>
            <tr>
