...
class ModelCatalogCourier extends Model {
	public function addCourier($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "courier SET courier_name = '" . $this->db->escape($data['courier_name']) . "', sort_order = '" . (int)$data['sort_order'] . "'");
	...
	public function editCourier($courier_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "courier SET courier_name = '" . $this->db->escape($data['courier_name']) . "', sort_order = '" . (int)$data['sort_order'] . "' WHERE courier_id = '" . (int)$courier_id . "'");
