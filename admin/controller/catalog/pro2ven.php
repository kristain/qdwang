<?php 
class ControllerCatalogPro2Ven extends Controller {
	private $error = array(); 
  	...
  	public function insert() {
		...
		if (!$this->OverMaxLimit()) {
			if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
				$this->model_catalog_pro2ven->addProduct($this->request->post);
				...
				$this->redirect($this->url->link('catalog/pro2ven', 'token=' . $this->session->data['token'] . $url, 'SSL'));
			}
			$this->getForm();
		} else {
			$this->getList();
  	...
  	public function update() {
    	...
    	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm() && $this->validateUpdate()) {
			$this->model_catalog_pro2ven->editProduct($this->request->get['product_id'], $this->request->post);
  	...
  	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $product_id) {
				$this->model_catalog_pro2ven->deleteProduct($product_id);
	  		}
  	...
  	public function copy() {
		...
		if (isset($this->request->post['selected']) && $this->validateCopy() && !$this->OverMaxLimit()) {
			foreach ($this->request->post['selected'] as $product_id) {
				$this->model_catalog_pro2ven->copyProduct($product_id);
	  		}
  	...
  	private function getList() {				
		...
		if (isset($this->request->get['page'])) {
  		...
  		$this->data['breadcrumbs'] = array();
   		...
   		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('catalog/pro2ven', 'token=' . $this->session->data['token'] . $url, 'SSL'),       		
      		'separator' => ' :: '
   		);
		
		$this->data['insert'] = $this->url->link('catalog/pro2ven/insert', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$this->data['copy'] = $this->url->link('catalog/pro2ven/copy', 'token=' . $this->session->data['token'] . $url, 'SSL');	
		$this->data['delete'] = $this->url->link('catalog/pro2ven/delete', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		$product_total = $this->model_catalog_pro2ven->getTotalProducts($data);
			
		$results = $this->model_catalog_pro2ven->getProducts($data);
		...
		foreach ($results as $result) {
			...
			$action[] = array(
				...
				'href' => $this->url->link('catalog/pro2ven/update', 'token=' . $this->session->data['token'] . '&product_id=' . $result['product_id'] . $url, 'SSL')
			);
			...
			$product_specials = $this->model_catalog_pro2ven->getProductSpecials($result['product_id']);
		...
		/*code start*/			
		$this->data['sort_name'] = $this->url->link('catalog/pro2ven', 'token=' . $this->session->data['token'] . '&sort=pd.name' . $url, 'SSL');
		$this->data['sort_model'] = $this->url->link('catalog/pro2ven', 'token=' . $this->session->data['token'] . '&sort=p.model' . $url, 'SSL');
		$this->data['sort_sku'] = $this->url->link('catalog/pro2ven', 'token=' . $this->session->data['token'] . '&sort=p.sku' . $url, 'SSL');
		$this->data['sort_price'] = $this->url->link('catalog/pro2ven', 'token=' . $this->session->data['token'] . '&sort=p.price' . $url, 'SSL');
		$this->data['sort_quantity'] = $this->url->link('catalog/pro2ven', 'token=' . $this->session->data['token'] . '&sort=p.quantity' . $url, 'SSL');
		$this->data['sort_status'] = $this->url->link('catalog/pro2ven', 'token=' . $this->session->data['token'] . '&sort=p.status' . $url, 'SSL');
		$this->data['sort_order'] = $this->url->link('catalog/pro2ven', 'token=' . $this->session->data['token'] . '&sort=p.sort_order' . $url, 'SSL');
		/*code end*/
		...
		$pagination->url = $this->url->link('catalog/pro2ven', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$this->template = 'catalog/pro2ven_list.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
  	...
  	private function getForm() {
		...
		if ($this->user->getCP()) {
			$this->data['category_access'] = unserialize($this->user->getCP());
		} else {
			$this->data['category_access'] = '0';
		}
			
		if ($this->user->getSP()) {
			$this->data['store_permission'] = unserialize($this->user->getSP());
		} else {
			$this->data['store_permission'] = '0';
		}
									
		if (!isset($this->request->get['product_id'])) {
			$this->data['action'] = $this->url->link('catalog/pro2ven/insert', 'token=' . $this->session->data['token'] . $url, 'SSL');
		} else {
			$this->data['action'] = $this->url->link('catalog/pro2ven/update', 'token=' . $this->session->data['token'] . '&product_id=' . $this->request->get['product_id'] . $url, 'SSL');
		}
		
		$this->data['cancel'] = $this->url->link('catalog/pro2ven', 'token=' . $this->session->data['token'] . $url, 'SSL');

		if (isset($this->request->get['product_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
      		$product_info = $this->model_catalog_pro2ven->getProduct($this->request->get['product_id']);
    	}elseif (isset($this->request->get['copy_product_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
      		$product_info = $this->model_catalog_product->getProduct($this->request->get['copy_product_id']);
    	}
		...
		if (isset($this->request->post['product_description'])) {
			...
			$this->data['product_description'] = $this->model_catalog_pro2ven->getProductDescriptions($this->request->get['product_id']);
		} elseif (isset($this->request->get['copy_product_id'])) {
			$this->data['product_description'] = $this->model_catalog_pro2ven->getProductDescriptions($this->request->get['copy_product_id']);
		} else {
		...
		$this->data['countries'] = $this->model_catalog_pro2ven->getCountry();	
		
		if (isset($this->request->post['ori_country'])) {
      		$this->data['ori_country'] = $this->request->post['ori_country'];
    	} else if (isset($product_info)&&isset($product_info['ori_country'])) {
    	...
    	} else if (isset($product_info)&&isset($product_info['product_cost'])) {
			$this->data['product_cost'] = $product_info['product_cost'];
		} else {
      		$this->data['product_cost'] = '';
    	}
		
		$this->data['couriers'] = $this->model_catalog_pro2ven->getCourier();	
		if (isset($this->request->post['shipping_method'])) {
      		$this->data['shipping_method'] = $this->request->post['shipping_method'];
    	} else if (isset($product_info)&&isset($product_info['shipping_method'])) {
    	...
    	} else if (isset($product_info)&&isset($product_info['prefered_shipping'])) {
    	...
    	} else if (isset($product_info)&&isset($product_info['shipping_cost'])) {
    	...
    	} else if (isset($product_info)&&isset($product_info['vtotal'])) {
    	...
    	} else if (isset($product_info)&&isset($product_info['product_url'])) {
		...
		} elseif (isset($product_info)&&isset($product_info['vendor'])) {
    	...
    	} else if (isset($product_info)&&isset($product_info['wholesale'])) {
    	...
    	} else if (isset($product_info)&&isset($product_info['company'])) {
    	...
    	} else if (isset($product_info)&&isset($product_info['vname'])) {
    	...
    	} else if (isset($product_info)&&isset($product_info['telephone'])) {
    	...
    	} else if (isset($product_info)&&isset($product_info['fax'])) {
    	...
    	} else if (isset($product_info)&&isset($product_info['email'])) {
    	...
    	} else if (isset($product_info)&&isset($product_info['paypal_email'])) {
    	...
    	} else if (isset($product_info)&&isset($product_info['vendor_description'])) {
    	...
    	} else if (isset($product_info)&&isset($product_info['address'])) {
    	...
    	} else if (isset($product_info)&&isset($product_info['store_url'])) {
		...
		if (isset($vendor_info['vendor_id'])) {
			$this->data['default_vendor'] = $vendor_info['vendor_id'];
		} else {
			$this->data['default_vendor'] = '';
		}
		
		if (isset($vendor_info['country_id'])) {
			$this->data['default_country'] = $vendor_info['country_id'];
		} else {
			$this->data['default_country'] = '';
		}
		/*code end*/
		...
		if (isset($this->request->post['product_store'])) {
			...
			$this->data['product_store'] = $this->model_catalog_pro2ven->getProductStores($this->request->get['product_id']);
		} elseif (isset($this->request->get['copy_product_id'])) {
			$this->data['product_store'] = $this->model_catalog_pro2ven->getProductStores($this->request->get['copy_product_id']);
		}else {
		...
		if (isset($this->request->post['product_attribute'])) {
			...
			$this->data['product_attributes'] = $this->model_catalog_pro2ven->getProductAttributes($this->request->get['product_id']);
		} else {
		...
		if (isset($this->request->post['product_option'])) {
			...
			$product_options = $this->model_catalog_pro2ven->getProductOptions($this->request->get['product_id']);			
		} else {
		...
		if (isset($this->request->post['product_discount'])) {
			...
			$this->data['product_discounts'] = $this->model_catalog_pro2ven->getProductDiscounts($this->request->get['product_id']);
		} elseif (isset($this->request->get['copy_product_id'])) {
			$this->data['product_discounts'] = $this->model_catalog_pro2ven->getProductDiscounts($this->request->get['copy_product_id']);
		}else {
		...
		if (isset($this->request->post['product_special'])) {
			...
			$this->data['product_specials'] = $this->model_catalog_pro2ven->getProductSpecials($this->request->get['product_id']);
		} elseif (isset($this->request->get['copy_product_id'])) {
			$this->data['product_specials'] = $this->model_catalog_pro2ven->getProductSpecials($this->request->get['copy_product_id']);
		}else {
		...
		if (isset($this->request->post['product_image'])) {
			...
			$product_images = $this->model_catalog_pro2ven->getProductImages($this->request->get['product_id']);
		} elseif (isset($this->request->get['copy_product_id'])) {
			$product_images = $this->model_catalog_pro2ven->getProductImages($this->request->get['copy_product_id']);
		} else {
		...
		/*code start*/
		$this->load->model('catalog/down2ven');
		$this->data['downloads'] = $this->model_catalog_down2ven->getDownloads(0);
		/*code end*/
		
		if (isset($this->request->post['product_download'])) {
			$this->data['product_download'] = $this->request->post['product_download'];
		} elseif (isset($this->request->get['product_id'])) {
			$this->data['product_download'] = $this->model_catalog_pro2ven->getProductDownloads($this->request->get['product_id']);
		} elseif (isset($this->request->get['copy_product_id'])) {
			$this->data['product_download'] = $this->model_catalog_pro2ven->getProductDownloads($this->request->get['copy_product_id']);
		}else {
		...
		if (isset($this->request->post['product_category'])) {
			...
			$this->data['product_category'] = $this->model_catalog_pro2ven->getProductCategories($this->request->get['product_id']);
		} elseif (isset($this->request->get['copy_product_id'])) {
			$this->data['product_category'] = $this->model_catalog_pro2ven->getProductCategories($this->request->get['copy_product_id']);
		} else {
		...
		if (isset($this->request->post['product_related'])) {
			...
			$products = $this->model_catalog_pro2ven->getProductRelated($this->request->get['product_id']);
		} elseif (isset($this->request->get['copy_product_id'])) {		
			$products = $this->model_catalog_pro2ven->getProductRelated($this->request->get['copy_product_id']);
		}else {
			$products = array();
		}
		...
		foreach ($products as $product_id) {
			$related_info = $this->model_catalog_pro2ven->getProduct($product_id);
		...
		if (isset($this->request->post['product_reward'])) {
			...
			$this->data['product_reward'] = $this->model_catalog_pro2ven->getProductRewards($this->request->get['product_id']);
		} elseif (isset($this->request->get['copy_product_id'])) {
			$this->data['product_reward'] = $this->model_catalog_pro2ven->getProductRewards($this->request->get['copy_product_id']);
		}else {
		...
		if (isset($this->request->post['product_layout'])) {
			...
			$this->data['product_layout'] = $this->model_catalog_pro2ven->getProductLayouts($this->request->get['product_id']);
		} elseif (isset($this->request->get['copy_product_id'])) {
			$this->data['product_layout'] = $this->model_catalog_pro2ven->getProductLayouts($this->request->get['copy_product_id']);
		}else {
		...
		$this->template = 'catalog/pro2ven_form.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
  	...
  	private function validateForm() { 
    	if (!$this->user->hasPermission('modify', 'catalog/pro2ven')) {
	...
	public function autocomplete() {
		...
		if (isset($this->request->get['filter_name']) || isset($this->request->get['filter_model']) || isset($this->request->get['filter_sku']) || isset($this->request->get['filter_category_id'])) {
			...
			/*code start*/
			$results = $this->model_catalog_pro2ven->getProducts($data,$this->user->getVP());
			/*code end*/
			
			foreach ($results as $result) {
				$option_data = array();
				
				$product_options = $this->model_catalog_pro2ven->getProductOptions($result['product_id']);	
	...
	public function vendor() {
		...
		$results = $this->model_catalog_pro2ven->getVendorsByVendorId($vendor_id);
	...
	private function validateUpdate() { 
		...
		$this->load->model('catalog/pro2ven');
    	$isproductexist = $this->model_catalog_pro2ven->ValidateVendorUpdate($this->request->get['product_id']);
