...
class ControllerModuleTimer extends Controller {
	...
	public function index() {   
		...
		$this->data['entry_description_comment'] = $this->language->get('entry_description_comment');
		$this->data['entry_date'] = $this->language->get('entry_date');
		$this->data['entry_time'] = $this->language->get('entry_time');
		$this->data['entry_time_comment'] = $this->language->get('entry_time_comment');
		$this->data['entry_show_weeks'] = $this->language->get('entry_show_weeks');
	...
	private function validate() {
		if (!$this->user->hasPermission('modify', 'module/timer')) {
