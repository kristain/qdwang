...
class ControllerSaleCustomer extends Controller { 
	...
	public function approve() {
  	...
  	private function getList() {
		...
		if (isset($this->request->get['filter_shop_name'])) {
			$filter_shop_name = $this->request->get['filter_shop_name'];
		} else {
			$filter_shop_name = null;
		}
		...
		if (isset($this->request->get['filter_shop_name'])) {
			$url .= '&filter_shop_name=' . urlencode(html_entity_decode($this->request->get['filter_shop_name'], ENT_QUOTES, 'UTF-8'));
		}
		...
		$data = array(
			...
			'filter_shop_name'         => $filter_shop_name, 
		...
		$this->data['filter_shop_name'] = $filter_shop_name;
