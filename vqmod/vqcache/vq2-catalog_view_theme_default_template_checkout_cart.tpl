...
<div id="content"><?php echo $content_top; ?>
        ...
        <tbody>
          ...
          <tr>
            <td class="image"><?php if ($product['thumb']) { ?>
              ...
              <?php } ?></td>
            <td class="name"><a href="<?php echo $product['href']; ?>" alt="<?php echo $product['tag']; ?>" title="<?php echo $product['tag']; ?>"><?php echo $product['name']; ?></a>
            ...
            <td class="quantity">
			<a href="javascript:delOne('<?php echo $product['key']; ?>','<?php echo $product['minimum']; ?>')"><img height='18' width='18' src="catalog/view/theme/default/image/subtrct.jpg" alt="订单减1" title="订单减1" /></a>
			<input type="text"  id="<?php echo $product['key']; ?>" name="quantity[<?php echo $product['key']; ?>]" value="<?php echo $product['quantity']; ?>" size="1" />
			  <a href="javascript:addOne('<?php echo $product['key']; ?>')"><img height='18' width='18' src="catalog/view/theme/default/image/add.jpg" alt="订单加1" title="订单加1" /></a>	
              &nbsp;			  
              <input id="updateInfos" type="image" src="catalog/view/theme/default/image/update.png" alt="<?php echo $button_update; ?>" title="<?php echo $button_update; ?>" />
  ...
  <div class="buttons">
    <div class="right"><a href="javascript:test()" class="button"><?php echo $button_checkout; ?></a></div>
...
function test(){
 var val = "<?php echo $totals[0]['text']; ?>";
 var amount = val.substring(1);
  if(parseFloat(amount)<500){
    if(confirm("促销：买够500元免运费。本次不足500，需付10元运费；点“确定”提交订单并支付；点“取消”返回继续进货")){
	  top.location.href = "<?php echo $checkout; ?>";
	}else{
	  top.location.href = "<?php echo $continue; ?>";
	}
 }else{
 top.location.href = "<?php echo $checkout; ?>";
 }
...
function delOne(id,minimum){
   if(parseInt($("#"+id).val())==1){
     alert("订单量不能小于1");  
     return;
   }
   if(parseInt($("#"+id).val())==parseInt(minimum)){
     alert("订单量不能小于最小起订量："+minimum);     
	 return;
   }
   $("#"+id).val(parseInt($("#"+id).val())-1);
   //$("#updateInfos").click();
