...
class ControllerProductProduct extends Controller {
	...
	public function index() { 
		...
		if($this->isVisitorMobile() && $this->config->get('config_disable_addtocart_outofstock')) {
			...
			$this->data['vendorName'] = $product_info['vendorName'];
			$this->data['vendorImage'] = $this->model_tool_image->resize($product_info['vendorImage'],100,100);
			
			//自营信息
			$this->data['selfName'] = '学大大自营';
			$this->data['selfImage'] = $this->model_tool_image->resize('data/xdd.jpg',100,31);
			...
			$this->data['product_tag'] = $product_info['tag'];
     		          ...
     		          unset($this->session->data['cart'][$keyx]);
                         ...
                         if ($this->config->get('config_tax') == '0') {    
                          ...
                          $total = $total - $val;
                           ...
                           $json['price'] = sprintf($this->currency->format($products[$keyx]['price']));
