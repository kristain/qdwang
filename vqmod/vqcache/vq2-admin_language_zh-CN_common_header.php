...
$_['text_report_product_stock']        = '商品库存不足统计';
$_['text_report_customer_online']      = '上网统计';
...
$_['text_zone']                        = '国家地区';
$_['text_opencart_cn']                 = '中文支持(opencart.cn)';
	        $_['text_vendor_tool']       		   = '卖家管理';
			$_['text_pro2ven']      	 		   = '卖家商品';
			$_['text_add_vendors']       	       = '管理卖家';
			$_['text_add_courier']       		   = '管理快递';
			$_['text_vendor_sales']      	   	   = '销售情况';
			$_['text_vendor_sales_orders']         = '订单';
			$_['text_vendor_report']      	   	   = '报表';
			$_['text_vendor_transaction']      	   = '交易';
			$_['text_payment_history']      	   = '支付历史';
			$_['text_setup']       		   		   = '设置';
			$_['text_vendor_setting']      		   = '全局卖家设置';
			$_['text_vendor_commission']      	   = '手续费';
			$_['text_package_limit']      	   	   = '商品限制';
			$_['text_vendor_personal']      	   = '卖家个性化设置';
			$_['text_vendor_update_profile']   	   = '更新简介';
			$_['text_vendor_update_password']      = '更新密码';
