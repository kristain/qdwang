...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="product-info">
    ...
    <div class="right">
      <div class="description">
		...
		<?php if ($vendorName) { ?>
		<span>卖&nbsp;&nbsp;&nbsp;家：</span> <?php echo $vendorName; ?><br />
		<span></span><img src="<?php echo $vendorImage; ?>" title="" alt="" /><br />
		<?php }else{ ?>
		<span>卖&nbsp;&nbsp;&nbsp;家：</span> <?php echo $selfName; ?><br />
		<span></span><img src="<?php echo $selfImage; ?>" title="" alt="" /><br />
		<?php } ?>
		<span>备&nbsp;&nbsp;&nbsp;注：</span> <?php echo $product_tag; ?><br />
        <?php if ($reward) { ?>
        <span><?php echo $text_reward; ?></span> <?php echo $reward; ?><br />
        <?php } ?>
        <span><?php echo $text_stock; ?></span> <?php echo $stock; ?></div>
      <?php if ($price) { ?>
	  <input type='hidden' id='product_sku' value='<?php echo $sku; ?>'/>
      <div class="price"><?php // echo $text_price; ?>
        <?php if (!$special) { ?>
                 <div class="opprice"><?php echo $text_price; ?><?php echo $price."/".$sku; ?></div>
                                            
                        
        <?php } else { ?>
        <span class="price-old"><?php echo $price."/".$sku; ?></span> <span class="price-new"><div class="opprice"><?php echo $text_price; ?><?php echo $special."/".$sku; ?></div></span>
        <?php } ?>
        <br />
        <?php if ($tax) { ?>
 ...
 <!--将不显示促销活动的数量和金额显示出来 -->  
         <div class="discount">
          ...
          <?php echo sprintf($text_discount); ?>
          <?php echo sprintf($discount['quantity'].$sku); ?>，&nbsp&nbsp&nbsp&nbsp&nbsp
          <?php echo sprintf($discount['price']."/".$sku); ?><br />
          <?php } ?>
        </div>
		<br />
		<div class="discount"><?php echo  "修改购买数量,折扣价自动计算" ;?></div>
        <?php } 
		?>
  <!--		  --> 
      </div>
      ...
      <div class="cart">
        <div><?php echo $text_qty; ?>
                         <input id='bc' type="text" name="quantity" size="2" value="<?php echo $minimum; ?>" />
...
function a(){ 
	$.ajax({
		...
		success: function(json) {
			...
			if (json['success']) {
				$('.opprice').html ('<?php echo $text_price; ?>'+json['price']+'/'+$("#product_sku").val());
